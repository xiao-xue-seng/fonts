...
- ukai-tw.ttf（文鼎楷體 - 台灣教育部標準，居中標點）
- ukai-cn.ttf（文鼎楷體 - 大陸 GB 標準，靠下標點）
- uming-tw.ttf（文鼎明體 - 台灣教育部標準，居中標點）
- uming-cn.ttf（文鼎明體 - 大陸 GB 標準，靠下標點）
"""
...
# 定義要處理的 TTC 檔案資訊
TARGET_TTCS = [
    {"filename": "ukai.ttc", "prefix": "ukai", "label": "文鼎 PL 中楷 (UKai)"},
    {"filename": "uming.ttc", "prefix": "uming", "label": "文鼎 PL 細上海宋 (UMing)"},
]
